...
if(isset($_POST['submit'])) {
	...
	global $connection;
	$postID=$_GET['edit'];
	$query = "UPDATE admin_panel SET datetime='$dateTime', title='$title', category='$category', author='$Admin', image='$image', post='$post' WHERE id='$postID'";
				...
				<form action="editPost.php?edit=<?php echo $ID; ?>" method="POST" enctype="multipart/form-data">
					<fieldset>
						<div class="form-group">
							...
							<input value="<?php echo $TitleToBeUpdated; ?>" class="form-control" type="text" name="title" id="categoryname" placeholder="Title"><br>
